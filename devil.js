...
//𝙁𝘼𝙆𝙀 𝙉𝙔𝘼 𝘽𝘼𝙉𝙂
devilgamteng ='𝐑𝐀𝐅𝐀𝐓𝐀𝐁𝐎𝐓𝐙☕︎'
fake = '𝐑𝐀𝐅𝐀𝐓𝐀𝐁𝐎𝐓𝐙☕︎'
//Ganti No Owner Ok
const Tag = "6287704764819"		
...
//------------------< Store jualan >-------------------              
         case 'store':
               ...
               listmenuu = [`DIAMOND MOBILE LEGENDS`,`SEWA BOT`,`JASA EDIT`,`MURID BOT`,`JASA HITUNG POINT FT`,`ROOM CARD FF`,`WEB JUALAN`,`CULIK MEMBER`,`SUNTIK FOLL IG`]
               nombor = 1
               startnum = 0
               for (let x of listmenu) {
               const yy = {title: 'silahkan pilih menunya ' + nombor++,
               ...
               break
        case 'dmff':             
            devil.sendMessage(from, dmml(prefix), MessageType.text, {quoted: ftroli})
            break
       case 'sewabot':             
     ...
     case 'payment':
       ...
       SILAKAN KETIK MANUAL JIKA TIDAK TERLIHAT`
               ...
               break
      case 'gopay':
             reply(`GOPAY : 082331243615\n\n A/N Jangan Pake Gopayy`)
             break  
      case 'pulsa':
             reply(`PULSA : 082331243615\n\n KARTU Simpati`)
             break
      case 'dana':
             reply(`DANA : 082331243615\n\n Nando`)
             break   
      case 'qris':
             wew = fs.readFileSync(`./media/payment.jpg`)
             teks = `SCAN QRIS DI ATAS A/N rafliok`
...
//------------------< Premium >-------------------
       ...
       case 'buypremium':
       case 'sewabot':
              gopeynya = 'https://telegra.ph/file/832a6b7ba9bd6b2d948e3.jpg'
              teksnya = `*── 「 PRICE LIST 」 ──*
...
case 'tiktok':
              ...
              imageMsg = (await devil.prepareMessageMedia(fs.readFileSync(`./media/devil.jpg`), 'imageMessage', {thumbnail: fs.readFileSync(`./media/devil.jpg`)})).imageMessage
              buttonsMessage = {footerText:'Jangan Lupa Subscribe Yt RAFATA BOT WA\n Helpme tu 1k subscriber', imageMessage: imageMsg,
       ...
       case 'img2url':
         ...
         case 'asupan': // shansekai                
              ...
              .then(async (body) => {
               ...
               sendMediaURL(from, `http://sansekai.my.id/ptl_repost/${asupanx}`, '\`\`\`ASUPAN BRO GUA DAPAT DARI LORD ©rafata Botz\`\`\`')
...
//------------------< Ingfo Bot >-------------------
      case 'runtime':
              ...
              break
       case 'youtube': 
              reply(`Jangan Lupa Subscribe YT Owner:\n https://youtube.com/channel/UCj2Y72dGgN5yi_UfrAqta1g`)
              break
       case 'masukandata':
...
//------------------< Menunya Bang:v >-------------------
      case 'infoig':
             reply(`Jangan Lupa Follow Ig Owner Ya : https://www.instagram.com/rafliniegeng`)
             break
      case 'grupbot':
             reply('')
             break
