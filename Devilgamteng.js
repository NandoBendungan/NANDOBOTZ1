...
const starts = async (devil = new WAConnection()) => {
	...
	console.log(color(figlet.textSync('RAFLI GANTENG', {
		font: 'Standard',
	...
	console.log(color('[SOURCE CODE INI DIJAGA DAN DI LINDUNGI OLEH DEVIL&RAFLI]\n\n', 'orange'), color('\n======TERIMKASIH BANYAK KEPADA======\n•MHANKBARBAR\n•NINO\n•IKYADS\n•DEVIL\n•SEMUA PATNER SAYA\n•DZBOTZ\n•PENYEDIA APIKEY\n•DHANI BOTZ\n•MY TEAM\n•ZAK BOTZ\n•AKIRA\n•FAUZANBOTZ\n•VIZZBOTZ\n•RAFATABOTZ\n•SEMUA SUBSCRIBER', 'yellow'))
	console.log(color('\n\nKALO MAU REUP TAG😑\nKALAU ADA YG MINTA SURUH CEK YT ©RAFLI\nYOUTUBE RAFATA BOT WA', 'pink'))
	devil.browserDescription = ["RAFATA BOTZ", "Chrome", "3.0.0"];
